        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nServings = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReciepeStepID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Description = table.Column<string>(type: "TEXT", nullable: false),
                    RecipeID = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReciepeSteps", x => x.ReciepeStepID);
                    table.ForeignKey(
                        name: "FK_ReciepeSteps_Images_ImgID",
                        column: x => x.ImgID,
                        principalTable: "Images",
                        principalColumn: "ImgID");
                    table.ForeignKey(
                        name: "FK_ReciepeSteps_Recipes_RecipeID",
                        column: x => x.RecipeID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReciepeSteps_ImgID",
                table: "ReciepeSteps",
                column: "ImgID");

            migrationBuilder.CreateIndex(
                name: "IX_ReciepeSteps_RecipeID",
                table: "ReciepeSteps",
                column: "RecipeID");
